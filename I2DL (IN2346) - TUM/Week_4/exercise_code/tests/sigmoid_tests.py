...
class Sigmoid_Of_Zero(UnitTest):
    ...
    def define_failure_message(self):
        return "Sigmoid of 0 is incorrect. Expected: 0.5 Evaluated: " + \
            str(self.value)
...
class Sigmoid_Of_Zero_Array(UnitTest):
    ...
    def define_failure_message(self):
        return "The array values do not sum up to expected result. Expected: 2.5 Evaluated:" + \
            str(self.value)
...
class Sigmoid_Of_100(UnitTest):
    ...
    def define_failure_message(self):
        return "At an input of 100 value should be ~1. Expected ~ 1 Evaluated: " + \
            str(self.value)
...
class Sigmoid_Of_Array_of_100(UnitTest):
    ...
    def define_failure_message(self):
        return "At an input of 100 value should be ~1. Expected ~5 Evaluated: " + \
            str(self.value)
